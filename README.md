...
| **SQL Injection** | SQL injection UNION attack, retrieving data from other tables | Practicante | [Ver Reporte](./SQL-Injection/SQL-injection-UNION-attack-retrieving-data-from-other-tables) |
